...
export function ResourceForm({
  ...
  /**
   * Called after a successful submit (e.g. to close a dialog). The action
   * signals success by returning `{ error: "", success: true }`. Server
   * actions that redirect don't need this — the page unmounts anyway.
   */
  onSuccess?: () => void;
}) {
